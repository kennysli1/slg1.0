...
const ERR_MSG: Record<string, string> = {
  ...
  caravan_not_found: '商队已抵达或结束行程，请重新选择',
  caravan_unavailable: '商队已抵达、返程或结束行程，请重新选择可用商队',
  caravan_action_forbidden: '当前不能对这支商队执行该行动，请检查归属、盟友关系和视野',
  caravan_not_visible: '商队已离开视野，无法发起劫掠',
  caravan_not_related: '只能护送前往己方村庄或从己方村庄出发的商队',
  caravan_not_raidable: '不能劫掠己方或盟友关联的商队',
  caravan_not_escortable: '这支商队当前无法护送，请重新选择送货中的商队',
  caravan_returning: '商队正在返程，无法购买护卫',
  caravan_already_protected: '这支商队已经获得王国护卫保护',
  caravan_busy: '商队正在交战，请稍后重试',
  caravan_cannot_scout: '商队不能被侦察',
