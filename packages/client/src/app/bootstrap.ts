...
import { getCache, setCache, getTab, setTab, addReport, getPopState, setPopState, interpolatePop } from './state.js';
import { getMapCenter } from './refresh.js';
...
async function refreshAll() {
  ...
  try {
    ...
    if (pop.ok) {
      ...
      // prosperityMult/growthPerHour/potentialGrowthPerHour/mobilizeCap/popProsperityFullRatio/popProsperityMaxBonus/
