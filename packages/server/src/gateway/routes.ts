...
export const MODULE_MANIFESTS: ModuleManifest[] = [
  {
    ...
    publicActions: {
      ...
      PreviewAllianceWarParticipation: { command: 'alliance.PreviewWarParticipation', needAuth: true, injectPlayerId: true, schema: { planId: { type: 'string', minLen: 1, maxLen: 128 }, sourceVillageId: { type: 'string', minLen: 1, maxLen: 64 }, troops: { type: 'record_int', maxKeys: 20, minVal: 0, maxVal: 100000 } } },
