...
export const MODULE_MANIFESTS: ModuleManifest[] = [
  {
    ...
    publicActions: {
      ...
      CreateAllianceWarPlan: { command: 'alliance.CreateWarPlan', needAuth: true, injectPlayerId: true, schema: { mode: { type: 'enum', values: ['reinforce', 'raid', 'attack'] }, targetKind: { type: 'enum', values: ['village', 'pve'] }, targetVillage: { type: 'string', optional: true, minLen: 1, maxLen: 64 }, targetId: { type: 'string', optional: true, minLen: 1, maxLen: 64 }, q: { type: 'integer', min: -100, max: 100 }, r: { type: 'integer', min: -100, max: 100 }, countdownSec: { type: 'integer', optional: true, min: 10, max: 604800 }, participationCountdownSec: { type: 'integer', optional: true, min: 1, max: 604799 }, deadlineAt: { type: 'integer', optional: true, min: 0 } } },
      PreviewAllianceWarParticipation: { command: 'alliance.PreviewWarParticipation', needAuth: true, injectPlayerId: true, schema: { planId: { type: 'string', minLen: 1, maxLen: 128 }, sourceVillageId: { type: 'string', minLen: 1, maxLen: 64 }, troops: { type: 'record_int', maxKeys: 20, minVal: 0, maxVal: 100000 }, treasures: { type: 'string_array', optional: true, maxItems: 10, minLen: 1, maxLen: 64 } } },
      JoinAllianceWarPlan: { command: 'alliance.JoinWarPlan', needAuth: true, injectPlayerId: true, schema: { planId: { type: 'string', minLen: 1, maxLen: 128 }, sourceVillageId: { type: 'string', minLen: 1, maxLen: 64 }, troops: { type: 'record_int', maxKeys: 20, minVal: 1, maxVal: 100000 }, treasures: { type: 'string_array', optional: true, maxItems: 10, minLen: 1, maxLen: 64 } } },
      CancelAllianceWarParticipation: { command: 'alliance.CancelWarParticipation', needAuth: true, injectPlayerId: true, schema: { planId: { type: 'string', minLen: 1, maxLen: 128 } } },
    ...
    },
  {
    ...
    publicActions: {
      ...
      SendInvestigate: {
        command: 'movement.SendInvestigate', ownVillage: true, needAuth: true,
        schema: {
          targetId: { type: 'string', minLen: 1, maxLen: 64 },
          troops: { type: 'record_int', maxKeys: 20, minVal: 1, maxVal: 100000 },
          treasures: { type: 'string_array', optional: true, maxItems: 10, minLen: 1, maxLen: 64 },
