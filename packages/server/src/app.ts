...
export function createGameApp(opts?: {
  ...
  const modules = [
    ...
    player, meta, notifications, mercenary, trade, treasure, research, dialogue, task, vision, reputation, alchemy, kingdom, diceQuest,
  ] as const;
  ...
  return {
    ...
    economy, building, military, population, world, pve, diplomacy, movement, combat, player, meta, notifications, mercenary, trade, treasure, dialogue, task, vision, reputation, alchemy, kingdom, diceQuest, now,
